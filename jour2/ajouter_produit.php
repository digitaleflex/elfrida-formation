    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="" class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="nom" id="nom" class="form-control" value="<?= htmlspecialchars($_POST['nom'] ?? '') ?>" required>
                <small class="error"><?= isset($errors) && in_array("Le nom est obligatoire.", $errors) ? "Le nom est obligatoire." : "" ?></small>
            </div>
            <div class="col-md-6">
                <label for="prix" class="form-label">Prix :</label>
                <input type="number" step="0.01" name="prix" id="prix" class="form-control" value="<?= htmlspecialchars($_POST['prix'] ?? '') ?>" required>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="stock" id="stock" class="form-control" value="<?= htmlspecialchars($_POST['stock'] ?? '') ?>" required>
